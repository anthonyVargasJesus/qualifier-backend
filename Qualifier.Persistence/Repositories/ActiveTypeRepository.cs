...
{
    public class ActiveTypeRepository : IActiveTypeRepository
    {
        protected readonly DatabaseService _context;
        public ActiveTypeRepository(DatabaseService context)
        {
            _context = context;
        }

        public async Task Update(int id, ActiveTypeEntity entity)
        {
            entity.activeTypeId = id;
        ...
        {
            var entity = new ActiveTypeEntity();
            entity.activeTypeId = id;
            entity.updateDate = DateTime.UtcNow;

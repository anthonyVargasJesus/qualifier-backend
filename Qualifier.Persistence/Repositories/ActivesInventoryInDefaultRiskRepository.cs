...
{
    public class ActivesInventoryInDefaultRiskRepository : IActivesInventoryInDefaultRiskRepository
    {
        protected readonly DatabaseService _context;
        public ActivesInventoryInDefaultRiskRepository(DatabaseService context)
        {
            _context = context;
        }

        public async Task Update(int id, ActivesInventoryInDefaultRiskEntity entity)
        {
            entity.activesInventoryInDefaultRiskId = id;
        ...
        {
            var entity = new ActivesInventoryInDefaultRiskEntity();
            entity.activesInventoryInDefaultRiskId = id;
            entity.updateDate = DateTime.UtcNow;

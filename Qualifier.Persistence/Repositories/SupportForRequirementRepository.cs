...
{
    public class SupportForRequirementRepository : ISupportForRequirementRepository
    {
        protected readonly DatabaseService _context;
        public SupportForRequirementRepository(DatabaseService context)
        {
            _context = context;
        }

        public async Task Update(int id, SupportForRequirementEntity entity)
        {
            entity.supportForRequirementId = id;
        ...
        {
            var entity = new SupportForRequirementEntity();
            entity.supportForRequirementId = id;
            entity.updateDate = DateTime.UtcNow;

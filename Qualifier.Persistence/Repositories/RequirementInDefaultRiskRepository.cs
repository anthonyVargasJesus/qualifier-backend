...
{
    public class RequirementInDefaultRiskRepository : IRequirementInDefaultRiskRepository
    {
        protected readonly DatabaseService _context;
        public RequirementInDefaultRiskRepository(DatabaseService context)
        {
            _context = context;
        }

        public async Task Update(int id, RequirementInDefaultRiskEntity entity)
        {
            entity.requirementInDefaultRiskId = id;
        ...
        {
            var entity = new RequirementInDefaultRiskEntity();
            entity.requirementInDefaultRiskId = id;
            entity.updateDate = DateTime.UtcNow;

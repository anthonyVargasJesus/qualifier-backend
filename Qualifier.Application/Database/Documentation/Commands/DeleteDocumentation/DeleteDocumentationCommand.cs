...
{
    public class DeleteDocumentationCommand : IDeleteDocumentationCommand
    {
        private readonly IDatabaseService _databaseService;
        private readonly IDocumentationRepository _documentationRepository;

        public DeleteDocumentationCommand(IDatabaseService databaseService, IDocumentationRepository documentationRepository)
        {
        ...
        public async Task<Object> Execute(int id, int updateUserId)
        {
            try
            {
                ...
                await _documentationRepository.Delete(id, updateUserId);

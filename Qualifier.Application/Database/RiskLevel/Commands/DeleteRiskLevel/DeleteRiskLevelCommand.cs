...
{
    public class DeleteRiskLevelCommand : IDeleteRiskLevelCommand
    {
        private readonly IDatabaseService _databaseService;
        private readonly IRiskLevelRepository _riskLevelRepository;

        public DeleteRiskLevelCommand(IDatabaseService databaseService, IRiskLevelRepository riskLevelRepository)
        {
        ...
        public async Task<Object> Execute(int id, int updateUserId)
        {
            try
            {
                ...
                await _riskLevelRepository.Delete(id, updateUserId);

...
{
    public class DeleteActiveTypeCommand : IDeleteActiveTypeCommand
    {
        private readonly IDatabaseService _databaseService;
        private readonly IActiveTypeRepository _activeTypeRepository;

        public DeleteActiveTypeCommand(IDatabaseService databaseService, IActiveTypeRepository activeTypeRepository)
        {
        ...
        public async Task<Object> Execute(int id, int updateUserId)
        {
            try
            {
                ...
                await _activeTypeRepository.Delete(id, updateUserId);

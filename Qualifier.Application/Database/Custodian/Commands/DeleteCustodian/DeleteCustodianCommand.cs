...
{
    public class DeleteCustodianCommand : IDeleteCustodianCommand
    {
        private readonly IDatabaseService _databaseService;
        private readonly ICustodianRepository _custodianRepository;

        public DeleteCustodianCommand(IDatabaseService databaseService, ICustodianRepository custodianRepository)
        {
        ...
        public async Task<Object> Execute(int id, int updateUserId)
        {
            try
            {
                ...
                await _custodianRepository.Delete(id, updateUserId);

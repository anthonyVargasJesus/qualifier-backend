...
{
    public class DeleteMenaceCommand : IDeleteMenaceCommand
    {
        private readonly IDatabaseService _databaseService;
        private readonly IMenaceRepository _menaceRepository;

        public DeleteMenaceCommand(IDatabaseService databaseService, IMenaceRepository menaceRepository)
        {
        ...
        public async Task<Object> Execute(int id, int updateUserId)
        {
            try
            {
                ...
                await _menaceRepository.Delete(id, updateUserId);

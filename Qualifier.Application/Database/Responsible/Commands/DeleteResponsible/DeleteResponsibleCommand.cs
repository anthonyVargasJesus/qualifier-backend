...
{
    public class DeleteResponsibleCommand : IDeleteResponsibleCommand
    {
        private readonly IDatabaseService _databaseService;
        private readonly IResponsibleRepository _responsibleRepository;

        public DeleteResponsibleCommand(IDatabaseService databaseService, IResponsibleRepository responsibleRepository)
        {
        ...
        public async Task<Object> Execute(int id, int updateUserId)
        {
            try
            {
                ...
                await _responsibleRepository.Delete(id, updateUserId);

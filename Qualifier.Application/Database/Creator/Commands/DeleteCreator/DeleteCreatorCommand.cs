...
{
    public class DeleteCreatorCommand : IDeleteCreatorCommand
    {
        private readonly IDatabaseService _databaseService;
        private readonly ICreatorRepository _creatorRepository;

        public DeleteCreatorCommand(IDatabaseService databaseService, ICreatorRepository creatorRepository)
        {
        ...
        public async Task<Object> Execute(int id, int updateUserId)
        {
            try
            {
                ...
                await _creatorRepository.Delete(id, updateUserId);

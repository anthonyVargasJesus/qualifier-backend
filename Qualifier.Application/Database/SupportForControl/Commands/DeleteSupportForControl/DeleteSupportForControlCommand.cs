...
{
    public class DeleteSupportForControlCommand : IDeleteSupportForControlCommand
    {
        private readonly IDatabaseService _databaseService;
        private readonly ISupportForControlRepository _supportForControlRepository;

        public DeleteSupportForControlCommand(IDatabaseService databaseService, ISupportForControlRepository supportForControlRepository)
        {
        ...
        public async Task<Object> Execute(int id, int updateUserId)
        {
            try
            {
                ...
                await _supportForControlRepository.Delete(id, updateUserId);

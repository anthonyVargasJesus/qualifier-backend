...
{
    public class DeleteRequirementInDefaultRiskCommand : IDeleteRequirementInDefaultRiskCommand
    {
        private readonly IDatabaseService _databaseService;
        private readonly IRequirementInDefaultRiskRepository _requirementInDefaultRiskRepository;

        public DeleteRequirementInDefaultRiskCommand(IDatabaseService databaseService, IRequirementInDefaultRiskRepository requirementInDefaultRiskRepository)
        {
        ...
        public async Task<Object> Execute(int id, int updateUserId)
        {
            try
            {
                ...
                await _requirementInDefaultRiskRepository.Delete(id, updateUserId);

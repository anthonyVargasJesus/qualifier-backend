...
namespace Qualifier.Api.Controllers
{
    ...
    {
        [HttpGet("All")]
        public async Task<IActionResult> GetAll([FromServices] IGetAllCustodiansByCompanyIdQuery query)
        {
        ...
        [HttpGet()]
        public async Task<IActionResult> Get(int skip, int pageSize, string? search, [FromServices] IGetCustodiansByCompanyIdQuery query)
        {
            var accessToken = await HttpContext.GetTokenAsync("access_token");
            int companyId;
        ...
        [HttpGet("{id}")]
        public async Task<IActionResult> Get(int id, [FromServices] IGetCustodianByIdQuery getCustodianByIdQuery)
        {
            var res = await getCustodianByIdQuery.Execute(id);
            if (res.GetType() == typeof(BaseErrorResponseDto))
        ...
        [HttpPost()]
        public async Task<IActionResult> Create([FromBody] CreateCustodianDto model, 
            [FromServices] ICreateCustodianCommand createCustodianCommand)
        {
            var accessToken = await HttpContext.GetTokenAsync("access_token");
            int userId;
            ...
            var res = await createCustodianCommand.Execute(model);
            if (res.GetType() == typeof(BaseErrorResponseDto))
                return BadRequest(res);
            else
                return Ok(new
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put([FromBody] UpdateCustodianDto model, int id, 
            [FromServices] IUpdateCustodianCommand updateCustodianCommand)
        {
            var accessToken = await HttpContext.GetTokenAsync("access_token");
            int userId;
            ...
            var res = await updateCustodianCommand.Execute(model, id);
            if (res.GetType() == typeof(BaseErrorResponseDto))
                return BadRequest(res);
            else
                return Ok(new
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> delete(int id, [FromServices] IDeleteCustodianCommand deleteCustodianCommand)
        {
            var accessToken = await HttpContext.GetTokenAsync("access_token");
            int userIdValue;
            ...
            var res = await deleteCustodianCommand.Execute(id, userId);
            if (res.GetType() == typeof(BaseErrorResponseDto))
                return BadRequest(res);
            else
                return Ok(new

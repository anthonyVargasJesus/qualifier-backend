...
namespace Qualifier.Api.Controllers
{
    ...
    {
        [HttpGet("All")]
        public async Task<IActionResult> GetAll([FromServices] IGetAllControlTypesByCompanyIdQuery query)
        {
        ...
        [HttpGet()]
        public async Task<IActionResult> Get(int skip, int pageSize, string? search, [FromServices] IGetControlTypesByCompanyIdQuery query)
        {
            var accessToken = await HttpContext.GetTokenAsync("access_token");
            int companyId;
        ...
        [HttpGet("{id}")]
        public async Task<IActionResult> Get(int id, [FromServices] IGetControlTypeByIdQuery getControlTypeByIdQuery)
        {
            var res = await getControlTypeByIdQuery.Execute(id);
            if (res.GetType() == typeof(BaseErrorResponseDto))
        ...
        [HttpPost()]
        public async Task<IActionResult> Create([FromBody] CreateControlTypeDto model,
            [FromServices] ICreateControlTypeCommand createControlTypeCommand)
        {
            var accessToken = await HttpContext.GetTokenAsync("access_token");
            int userId;
            ...
            var res = await createControlTypeCommand.Execute(model);
            if (res.GetType() == typeof(BaseErrorResponseDto))
                return BadRequest(res);
            else
                return Ok(new
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put([FromBody] UpdateControlTypeDto model, int id,
            [FromServices] IUpdateControlTypeCommand updateControlTypeCommand)
        {
            var accessToken = await HttpContext.GetTokenAsync("access_token");
            int userId;
            ...
            var res = await updateControlTypeCommand.Execute(model, id);
            if (res.GetType() == typeof(BaseErrorResponseDto))
                return BadRequest(res);
            else
                return Ok(new
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> delete(int id, [FromServices] IDeleteControlTypeCommand deleteControlTypeCommand)
        {
            var accessToken = await HttpContext.GetTokenAsync("access_token");
            int userIdValue;
            ...
            var res = await deleteControlTypeCommand.Execute(id, userId);
            if (res.GetType() == typeof(BaseErrorResponseDto))
                return BadRequest(res);
            else
                return Ok(new

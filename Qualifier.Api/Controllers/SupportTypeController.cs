...
namespace Qualifier.Api.Controllers
{
    ...
    {
        [HttpGet("All")]
        public async Task<IActionResult> GetAll([FromServices] IGetAllSupportTypesByCompanyIdQuery query)
        {
        ...
        public async Task<IActionResult> Get(int skip, int pageSize, string? search, 
            [FromServices] IGetSupportTypesByCompanyIdQuery query)
        {
            var accessToken = await HttpContext.GetTokenAsync("access_token");
            int companyId;
        ...
        [HttpGet("{id}")]
        public async Task<IActionResult> Get(int id, [FromServices] IGetSupportTypeByIdQuery getSupportTypeByIdQuery)
        {
            var res = await getSupportTypeByIdQuery.Execute(id);
            if (res.GetType() == typeof(BaseErrorResponseDto))
        ...
        [HttpPost()]
        public async Task<IActionResult> Create([FromBody] CreateSupportTypeDto model, 
            [FromServices] ICreateSupportTypeCommand createSupportTypeCommand)
        {
            var accessToken = await HttpContext.GetTokenAsync("access_token");
            int userId;
            ...
            var res = await createSupportTypeCommand.Execute(model);
            if (res.GetType() == typeof(BaseErrorResponseDto))
                return BadRequest(res);
            else
                return Ok(new
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put([FromBody] UpdateSupportTypeDto model, int id, 
            [FromServices] IUpdateSupportTypeCommand updateSupportTypeCommand)
        {
            var accessToken = await HttpContext.GetTokenAsync("access_token");
            int userId;
            ...
            var res = await updateSupportTypeCommand.Execute(model, id);
            if (res.GetType() == typeof(BaseErrorResponseDto))
                return BadRequest(res);
            else
                return Ok(new
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> delete(int id, [FromServices] IDeleteSupportTypeCommand deleteSupportTypeCommand)
        {
            var accessToken = await HttpContext.GetTokenAsync("access_token");
            int userIdValue;
            ...
            var res = await deleteSupportTypeCommand.Execute(id, userId);
            if (res.GetType() == typeof(BaseErrorResponseDto))
                return BadRequest(res);
            else
                return Ok(new

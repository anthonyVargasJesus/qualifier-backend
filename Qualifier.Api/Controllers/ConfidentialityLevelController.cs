...
public class ConfidentialityLevelController(
    IGetAllConfidentialityLevelsByCompanyIdQuery getAllQuery,
    IGetConfidentialityLevelsByCompanyIdQuery getPagedQuery,
    IGetConfidentialityLevelByIdQuery getByIdQuery,
    ICreateConfidentialityLevelCommand createCommand,
    IUpdateConfidentialityLevelCommand updateCommand,
    IDeleteConfidentialityLevelCommand deleteCommand
) : ApiBaseController
{
    [HttpGet("all")]
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] CreateConfidentialityLevelDto model)
    {
    ...
    [HttpPut("{id:int}")]
    public async Task<IActionResult> Update(int id, [FromBody] UpdateConfidentialityLevelDto model)
    {

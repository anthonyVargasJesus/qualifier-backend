...
{
    public class DeleteRiskStatusCommand : IDeleteRiskStatusCommand
    {
        private readonly IDatabaseService _databaseService;
        private readonly IRiskStatusRepository _riskStatusRepository;

        public DeleteRiskStatusCommand(IDatabaseService databaseService, IRiskStatusRepository riskStatusRepository)
        {
        ...
        public async Task<Object> Execute(int id, int updateUserId)
        {
            try
            {
                ...
                await _riskStatusRepository.Delete(id, updateUserId);

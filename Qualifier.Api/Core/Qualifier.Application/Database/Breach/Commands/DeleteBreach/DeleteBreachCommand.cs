...
{
    public class DeleteBreachCommand : IDeleteBreachCommand
    {
        private readonly IDatabaseService _databaseService;
        private readonly IBreachRepository _breachRepository;

        public DeleteBreachCommand(IDatabaseService databaseService, IBreachRepository breachRepository)
        {
        ...
        public async Task<Object> Execute(int id, int updateUserId)
        {
            try
            {
                ...
                await _breachRepository.Delete(id, updateUserId);

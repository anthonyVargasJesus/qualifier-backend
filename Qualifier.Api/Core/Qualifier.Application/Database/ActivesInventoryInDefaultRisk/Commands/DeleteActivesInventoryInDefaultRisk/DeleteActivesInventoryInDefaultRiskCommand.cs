...
{
public class DeleteActivesInventoryInDefaultRiskCommand : IDeleteActivesInventoryInDefaultRiskCommand
{
private readonly IDatabaseService _databaseService;
private readonly IActivesInventoryInDefaultRiskRepository _activesInventoryInDefaultRiskRepository;

public DeleteActivesInventoryInDefaultRiskCommand(IDatabaseService databaseService, IActivesInventoryInDefaultRiskRepository activesInventoryInDefaultRiskRepository)
{
...
await _activesInventoryInDefaultRiskRepository.Delete(id, updateUserId);

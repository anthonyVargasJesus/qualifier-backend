...
{
    public class DeleteSubprocessCommand : IDeleteSubprocessCommand
    {
        private readonly IDatabaseService _databaseService;
        private readonly ISubprocessRepository _subprocessRepository;

        public DeleteSubprocessCommand(IDatabaseService databaseService, ISubprocessRepository subprocessRepository)
        {
        ...
        public async Task<Object> Execute(int id, int updateUserId)
        {
            try
            {
                ...
                await _subprocessRepository.Delete(id, updateUserId);

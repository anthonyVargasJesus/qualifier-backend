...
{
    public class DeleteIndicatorCommand : IDeleteIndicatorCommand
    {
        private readonly IDatabaseService _databaseService;
        private readonly IIndicatorRepository _repository;

        public DeleteIndicatorCommand(IDatabaseService databaseService, IIndicatorRepository repository)
        {

...
{
    public class DeleteRiskCommand : IDeleteRiskCommand
    {
        private readonly IDatabaseService _databaseService;
        private readonly IRiskRepository _riskRepository;

        public DeleteRiskCommand(IDatabaseService databaseService, IRiskRepository riskRepository)
        {
        ...
        public async Task<Object> Execute(int id, int updateUserId)
        {
            try
            {
                ...
                await _riskRepository.Delete(id, updateUserId);

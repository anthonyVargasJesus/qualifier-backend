...
{
    public class DeletePersonalCommand : IDeletePersonalCommand
    {
        private readonly IDatabaseService _databaseService;
        private readonly IPersonalRepository _personalRepository;

        public DeletePersonalCommand(IDatabaseService databaseService, IPersonalRepository personalRepository)
        {
        ...
        public async Task<Object> Execute(int id, int updateUserId)
        {
            try
            {
                ...
                await _personalRepository.Delete(id, updateUserId);

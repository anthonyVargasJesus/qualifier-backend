...
{
    public class DeleteActionPlanCommand : IDeleteActionPlanCommand
    {
        private readonly IDatabaseService _databaseService;
        private readonly IActionPlanRepository _actionPlanRepository;

        public DeleteActionPlanCommand(IDatabaseService databaseService, IActionPlanRepository actionPlanRepository)
        {
        ...
        public async Task<Object> Execute(int id, int updateUserId)
        {
            try
            {
                ...
                await _actionPlanRepository.Delete(id, updateUserId);

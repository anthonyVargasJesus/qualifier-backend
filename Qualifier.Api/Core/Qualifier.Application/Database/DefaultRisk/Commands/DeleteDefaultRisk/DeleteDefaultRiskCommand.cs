...
{
    public class DeleteDefaultRiskCommand : IDeleteDefaultRiskCommand
    {
        private readonly IDatabaseService _databaseService;
        private readonly IDefaultRiskRepository _defaultRiskRepository;

        public DeleteDefaultRiskCommand(IDatabaseService databaseService, IDefaultRiskRepository defaultRiskRepository)
        {
        ...
        public async Task<Object> Execute(int id, int updateUserId)
        {
            try
            {
                ...
                await _defaultRiskRepository.Delete(id, updateUserId);

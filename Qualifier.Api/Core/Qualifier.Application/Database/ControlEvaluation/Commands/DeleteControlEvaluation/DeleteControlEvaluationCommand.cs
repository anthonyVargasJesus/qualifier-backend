...
{
    public class DeleteControlEvaluationCommand : IDeleteControlEvaluationCommand
    {
        private readonly IDatabaseService _databaseService;
        private readonly IControlEvaluationRepository _controlEvaluationRepository;

        public DeleteControlEvaluationCommand(IDatabaseService databaseService, IControlEvaluationRepository controlEvaluationRepository)
        {
        ...
        public async Task<Object> Execute(int id, int updateUserId)
        {
            try
            {
                ...
                await _controlEvaluationRepository.Delete(id, updateUserId);

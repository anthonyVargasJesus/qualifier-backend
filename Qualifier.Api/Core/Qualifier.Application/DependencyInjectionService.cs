...
namespace Qualifier.Application
{
    public static class DependencyInjectionService
    {
        public static IServiceCollection AddApplication(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddTransient<IMarkNotificationAsReadCommand, MarkNotificationAsReadCommand>();
            services.AddTransient<IMarkAllNotificationsAsReadCommand, MarkAllNotificationsAsReadCommand>();
            ...
            services.AddTransient<IGetReferenceDocumentationsByControlEvaluationIdQuery, GetReferenceDocumentationsByControlEvaluationIdQuery>();

            //DefaultRisk
            services.AddTransient<ICreateDefaultRiskCommand, CreateDefaultRiskCommand>();
            services.AddTransient<IUpdateDefaultRiskCommand, UpdateDefaultRiskCommand>();
            services.AddTransient<IDeleteDefaultRiskCommand, DeleteDefaultRiskCommand>();
            services.AddTransient<IGetDefaultRiskByIdQuery, GetDefaultRiskByIdQuery>();
            services.AddTransient<IGetAllDefaultRisksByStandardIdQuery, GetAllDefaultRisksByStandardIdQuery>();
            services.AddTransient<IGetDefaultRisksByStandardIdQuery, GetDefaultRisksByStandardIdQuery>();

            //RequirementInDefaultRisk
            services.AddTransient<ICreateRequirementInDefaultRiskCommand, CreateRequirementInDefaultRiskCommand>();
            services.AddTransient<IUpdateRequirementInDefaultRiskCommand, UpdateRequirementInDefaultRiskCommand>();
            services.AddTransient<IDeleteRequirementInDefaultRiskCommand, DeleteRequirementInDefaultRiskCommand>();
            services.AddTransient<IGetRequirementInDefaultRiskByIdQuery, GetRequirementInDefaultRiskByIdQuery>();
            services.AddTransient<IGetAllRequirementInDefaultRisksByRequirementIdQuery, GetAllRequirementInDefaultRisksByRequirementIdQuery>();
            services.AddTransient<IGetRequirementInDefaultRisksByRequirementIdQuery, GetRequirementInDefaultRisksByRequirementIdQuery>();

            //ControlInDefaultRisk
            services.AddTransient<ICreateControlInDefaultRiskCommand, CreateControlInDefaultRiskCommand>();
            services.AddTransient<IUpdateControlInDefaultRiskCommand, UpdateControlInDefaultRiskCommand>();
            services.AddTransient<IDeleteControlInDefaultRiskCommand, DeleteControlInDefaultRiskCommand>();
            services.AddTransient<IGetControlInDefaultRiskByIdQuery, GetControlInDefaultRiskByIdQuery>();
            services.AddTransient<IGetAllControlInDefaultRisksByControlIdQuery, GetAllControlInDefaultRisksByControlIdQuery>();
            services.AddTransient<IGetControlInDefaultRisksByControlIdQuery, GetControlInDefaultRisksByControlIdQuery>();

            //ActivesInventoryInDefaultRisk
            services.AddTransient<ICreateActivesInventoryInDefaultRiskCommand, CreateActivesInventoryInDefaultRiskCommand>();
            services.AddTransient<IUpdateActivesInventoryInDefaultRiskCommand, UpdateActivesInventoryInDefaultRiskCommand>();
            services.AddTransient<IDeleteActivesInventoryInDefaultRiskCommand, DeleteActivesInventoryInDefaultRiskCommand>();
            services.AddTransient<IGetActivesInventoryInDefaultRiskByIdQuery, GetActivesInventoryInDefaultRiskByIdQuery>();
            services.AddTransient<IGetAllActivesInventoryInDefaultRisksByDefaultRiskIdQuery, GetAllActivesInventoryInDefaultRisksByDefaultRiskIdQuery>();
            services.AddTransient<IGetActivesInventoryInDefaultRisksByDefaultRiskIdQuery, GetActivesInventoryInDefaultRisksByDefaultRiskIdQuery>();

            //Breach
            services.AddTransient<ICreateBreachCommand, CreateBreachCommand>();
            services.AddTransient<IUpdateBreachCommand, UpdateBreachCommand>();
            ...
            services.AddTransient<IUpdateRiskStatusCommand, UpdateRiskStatusCommand>();
            services.AddTransient<IDeleteRiskStatusCommand, DeleteRiskStatusCommand>();
            services.AddTransient<IGetRiskStatusByIdQuery, GetRiskStatusByIdQuery>();
            services.AddTransient<IGetAllRiskStatussByCompanyIdQuery, GetAllRiskStatussByCompanyIdQuery>();
            services.AddTransient<IGetRiskStatussByCompanyIdQuery, GetRiskStatussByCompanyIdQuery>();
            
            //RiskAssessment
            services.AddTransient<IDeleteRiskAssessmentCommand, DeleteRiskAssessmentCommand>();

            //RiskTreatment
            services.AddTransient<IDeleteRiskTreatmentCommand, DeleteRiskTreatmentCommand>();

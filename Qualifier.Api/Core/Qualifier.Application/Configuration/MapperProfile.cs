...
namespace Qualifier.Application.Configuration
{
    public class MapperProfile : Profile
    {
        public MapperProfile()
        {
            ...
            //RiskStatus
            CreateMap<RiskStatusEntity, CreateRiskStatusDto>().ReverseMap();
            CreateMap<RiskStatusEntity, UpdateRiskStatusDto>().ReverseMap();
            CreateMap<RiskStatusEntity, GetRiskStatusByIdDto>().ReverseMap();
            CreateMap<RiskStatusEntity, GetAllRiskStatussByCompanyIdDto>().ReverseMap();
            CreateMap<RiskStatusEntity, GetRiskStatussByCompanyIdDto>().ReverseMap();

            //ControlImplementation
            CreateMap<ControlImplementationEntity, GetControlImplementationsByRiskIdDto>().ReverseMap();
            CreateMap<ResponsibleEntity, GetControlImplementationsByRiskIdResponsibleDto>().ReverseMap();

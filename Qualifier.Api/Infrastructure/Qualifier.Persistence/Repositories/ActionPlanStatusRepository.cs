...
{
    public class ActionPlanStatusRepository : IActionPlanStatusRepository
    {
        protected readonly DatabaseService _context;
        public ActionPlanStatusRepository(DatabaseService context)
        {
            _context = context;
        }

        public async Task Update(int id, ActionPlanStatusEntity entity)
        {
            entity.actionPlanStatusId = id;
        ...
        {
            var entity = new ActionPlanStatusEntity();
            entity.actionPlanStatusId = id;
            entity.updateDate = DateTime.UtcNow;

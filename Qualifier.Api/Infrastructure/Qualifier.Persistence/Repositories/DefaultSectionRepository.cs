...
{
    public class DefaultSectionRepository : IDefaultSectionRepository
    {
        protected readonly DatabaseService _context;
        public DefaultSectionRepository(DatabaseService context)
        {
            _context = context;
        }

        public async Task Update(int id, DefaultSectionEntity entity)
        {
            entity.defaultSectionId = id;
        ...
        {
            var entity = new DefaultSectionEntity();
            entity.defaultSectionId = id;
            entity.updateDate = DateTime.UtcNow;

...
{
    public class MaturityLevelRepository : IMaturityLevelRepository
    {
        protected readonly DatabaseService _context;
        public MaturityLevelRepository(DatabaseService context)
        {
            _context = context;
        }

        public async Task Update(int id, MaturityLevelEntity entity)
        {
            entity.maturityLevelId = id;
        ...
        {
            var entity = new MaturityLevelEntity();
            entity.maturityLevelId = id;
            entity.updateDate = DateTime.UtcNow;

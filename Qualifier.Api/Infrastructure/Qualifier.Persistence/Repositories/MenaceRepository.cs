...
{
    public class MenaceRepository : IMenaceRepository
    {
        protected readonly DatabaseService _context;
        public MenaceRepository(DatabaseService context)
        {
            _context = context;
        }

        public async Task Update(int id, MenaceEntity entity)
        {
            entity.menaceId = id;
            entity.updateDate = DateTime.UtcNow;
            var entry = _context.Attach(entity);
            entry.Property(x => x.menaceTypeId).IsModified = true;

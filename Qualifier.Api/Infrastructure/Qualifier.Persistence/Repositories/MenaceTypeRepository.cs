...
{
    public class MenaceTypeRepository : IMenaceTypeRepository
    {
        protected readonly DatabaseService _context;
        public MenaceTypeRepository(DatabaseService context)
        {
            _context = context;
        }

        public async Task Update(int id, MenaceTypeEntity entity)
        {
            entity.menaceTypeId = id;
        ...
        {
            var entity = new MenaceTypeEntity();
            entity.menaceTypeId = id;
            entity.updateDate = DateTime.UtcNow;

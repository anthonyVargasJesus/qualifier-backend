...
namespace Qualifier.Api.Infrastructure.Qualifier.Persistence.Repositories
{
    public class RiskStatusRepository : IRiskStatusRepository
    {
        ...
        public RiskStatusRepository(DatabaseService context)
        {
            _context = context;
        }

        public async Task Update(int id, RiskStatusEntity entity)
        {
            entity.riskStatusId = id;
        ...
        {
            var entity = new RiskStatusEntity();
            entity.riskStatusId = id;
            entity.updateDate = DateTime.UtcNow;

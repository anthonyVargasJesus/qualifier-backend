...
{
    public class ResidualRiskRepository : IResidualRiskRepository
    {
        protected readonly DatabaseService _context;
        public ResidualRiskRepository(DatabaseService context)
        {
            _context = context;
        }

        public async Task Update(int id, ResidualRiskEntity entity)
        {
            entity.residualRiskId = id;
        ...
        {
            var entity = new ResidualRiskEntity();
            entity.residualRiskId = id;
            entity.updateDate = DateTime.UtcNow;

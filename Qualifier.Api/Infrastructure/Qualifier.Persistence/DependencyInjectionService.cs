...
using Qualifier.Api.Infrastructure.Qualifier.Persistence.Repositories;
using Qualifier.Application.Database;
using Qualifier.Domain.Interfaces;


namespace Qualifier.Api.Infrastructure.Qualifier.Persistence
{
    public static class DependencyInjectionService
    {
        ...
        public static IServiceCollection AddPersistence(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped<IActionPlanStatusRepository, ActionPlanStatusRepository>();
            services.AddScoped<IActionPlanPriorityRepository, ActionPlanPriorityRepository>();
